(function(window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        contactForm: function() {
            $('.theme-contact-form').on('submit', function(e) {
                e.preventDefault();
                var _self = $(this);
        ...
        stickyHeaderMenu: function() {
            ...
            $(window).on('scroll', function() {
                ...
                if ($('body').hasClass('sticky-header')) {
                    var stickyPlaceHolder = $('#theme-sticky-placeholder'),
                        menu = $('.theme-mainmenu'),
                        menuH = menu.outerHeight(),
                        topHeaderH = $('.theme-header-top').outerHeight() || 0,
                        targrtScroll = topHeaderH + 200;
                    if ($(window).scrollTop() > targrtScroll) {
                        menu.addClass('theme-sticky');
                        stickyPlaceHolder.height(menuH);
                    } else {
                        menu.removeClass('theme-sticky');
        ...
        mobileMenuActivation: function(e) {
            ...
            $('.menu-item-has-children > a').on('click', function(e) {
                ...
                var targetParent = $(this).parents('.mainmenu-nav'),
                    target = $(this).siblings('.theme-submenu'),
                    targetSiblings = $(this).parent('.menu-item-has-children').siblings().find('.theme-submenu');
            ...
            function resizeClassAdd() {
                if (window.matchMedia('(min-width: 992px)').matches) {
                    ...
                    $('.theme-mainmenu .offcanvas-backdrop').remove();
                    $('.theme-submenu').removeAttr('style');
                } else {
        ...
        axilMasonary: function () {
            $('.theme-isotope-wrapper').imagesLoaded(function () {
        ...
        caseModalActivation : function () {
            ...
            if ($('body').hasClass('onepage-template')) {
                ...
                caseList.each(function() {
                    ...
                    var $this = $(this);
                    var buttons = $this.find('.theme-btn');
                    var title = $this.find('.title');
